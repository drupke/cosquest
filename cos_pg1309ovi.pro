FUNCTION cos_pg1309ovi, directoryname, gal, zgal, profileshifts, profilesig, coveringfactor,$
  ...
  indextoplot=[INDGEN(VALUE_LOCATE(wavelength,1205.6),START=spectramin),$
;    INDGEN(VALUE_LOCATE(wavelength,1207.3)-VALUE_LOCATE(wavelength,1207),START=VALUE_LOCATE(wavelength,1207)),$
;    INDGEN(VALUE_LOCATE(wavelength,1210.8)-VALUE_LOCATE(wavelength,1210.4),START=VALUE_LOCATE(wavelength,1210.4)),$
;    INDGEN(VALUE_LOCATE(wavelength,1212.4)-VALUE_LOCATE(wavelength,1212.1),START=VALUE_LOCATE(wavelength,1212.1)),$
;    INDGEN(VALUE_LOCATE(wavelength,1213.1)-VALUE_LOCATE(wavelength,1212.9),START=VALUE_LOCATE(wavelength,1212.9)),$
;    INDGEN(VALUE_LOCATE(wavelength,1213.75)-VALUE_LOCATE(wavelength,1213.7),START=VALUE_LOCATE(wavelength,1213.7)),$
;    INDGEN(VALUE_LOCATE(wavelength,1218)-VALUE_LOCATE(wavelength,1217),START=VALUE_LOCATE(wavelength,1217)),$
    INDGEN(N_ELEMENTS(wavelength)-VALUE_LOCATE(wavelength,1227.3),START=VALUE_LOCATE(wavelength,1227.3))]
  weight=1d/error^2
  fitreg=[[MIN(wavelength),1202],[1202,1215.5],[1215.5,1230],[1230,MAX(wavelength)]]
