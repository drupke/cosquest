FUNCTION cos_pg1004ovi, directoryname, gal, zgal, profileshifts, profilesig, coveringfactor,$
...
;  checkindex2=lines['[NV2]1243']+50
  zgalint=DOUBLE(zgal)
  doubletregion=[1272,1289]
  checkindex=[1270,1289]
  ...
  hydrogenabsorptionregion=[VALUE_LOCATE(wavelength,1220),VALUE_LOCATE(wavelength,1230)]
  spectramin=VALUE_LOCATE(wavelength,MIN(wavelength))
  spectramax=VALUE_LOCATE(wavelength,MAX(wavelength))
  indextoplot=[INDGEN(VALUE_LOCATE(wavelength,1271.5),START=spectramin), $
    INDGEN(VALUE_LOCATE(wavelength,1274.2)-VALUE_LOCATE(wavelength,1273.4),START=VALUE_LOCATE(wavelength,1273.4)),$
    INDGEN(VALUE_LOCATE(wavelength,1277.15)-VALUE_LOCATE(wavelength,1276.95),START=VALUE_LOCATE(wavelength,1276.9)), $
    INDGEN(VALUE_LOCATE(wavelength,1279.7)-VALUE_LOCATE(wavelength,1279.4),START=VALUE_LOCATE(wavelength,1279.4)),$
    INDGEN(VALUE_LOCATE(wavelength,1280.4)-VALUE_LOCATE(wavelength,1280.1),START=VALUE_LOCATE(wavelength,1280.1)),$
    INDGEN(VALUE_LOCATE(wavelength,1281.8)-VALUE_LOCATE(wavelength,1281),START=VALUE_LOCATE(wavelength,1281)),$
    INDGEN(VALUE_LOCATE(wavelength,1284.2)-VALUE_LOCATE(wavelength,1284),START=VALUE_LOCATE(wavelength,1284)),$
    INDGEN(VALUE_LOCATE(wavelength,1286.6)-VALUE_LOCATE(wavelength,1286.4),START=VALUE_LOCATE(wavelength,1286.4)),$
    INDGEN(N_ELEMENTS(wavelength)-VALUE_LOCATE(wavelength,1287.3),START=VALUE_LOCATE(wavelength,1287.3))]
  weight=1d/error^2
  fitreg=[[MIN(wavelength),1270],[1270,1300],[1300,MAX(wavelength)]]
  fitfcn=['ifsf_fitspline','ifsf_fitspline','ifsf_fitspline']
  fitargs=HASH()
  fitargs['reg1'] = {argsbkpts:{everyn:40}}
  fitargs['reg2'] = {argsbkpts:{everyn:89}}
  ...
  error[VALUE_LOCATE(wavelength, 1280.3):VALUE_LOCATE(wavelength,1281.2)] = 1d99
