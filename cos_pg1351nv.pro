FUNCTION cos_pg1351nv, directoryname, gal, zgal, profileshifts, profilesig, coveringfactor,$
...
;  checkindex2=lines['[NV2]1243']+50
  zgalint=DOUBLE(zgal)
  doubletregion=[1337,1350]
  checkindex=[1338,1351]
  ...
  Doubletabsorptionregion=[VALUE_LOCATE(wavelength,1339.2),VALUE_LOCATE(wavelength,1350)]
  hydrogenabsorptionregion=[VALUE_LOCATE(wavelength,1314),VALUE_LOCATE(wavelength,1320.5)]
  spectramin=VALUE_LOCATE(wavelength,MIN(wavelength))
  spectramax=VALUE_LOCATE(wavelength,MAX(wavelength))
  indextoplot=[INDGEN(hydrogenabsorptionregion[0],START=spectramin), $
    INDGEN(VALUE_LOCATE(wavelength,1316.9)-VALUE_LOCATE(wavelength,1316.6),START=VALUE_LOCATE(wavelength,1316.5)),$
    INDGEN(VALUE_LOCATE(wavelength,1323)-hydrogenabsorptionregion[1],START=hydrogenabsorptionregion[1]), $
    INDGEN(VALUE_LOCATE(wavelength,1333)-VALUE_LOCATE(wavelength,1323.3),START=VALUE_LOCATE(wavelength,1323.3)),$
    INDGEN(doubletabsorptionregion[0]-VALUE_LOCATE(wavelength,1336),START=VALUE_LOCATE(wavelength,1336)),$
    INDGEN(VALUE_LOCATE(wavelength,1341.9)-VALUE_LOCATE(wavelength,1341),START=VALUE_LOCATE(wavelength,1341.5)),$
    INDGEN(VALUE_LOCATE(wavelength,1346.7)-VALUE_LOCATE(wavelength,1345.6),START=VALUE_LOCATE(wavelength,1345.6)),$
    INDGEN(N_ELEMENTS(wavelength)-doubletabsorptionregion[1],START=doubletabsorptionregion[1])]
  weight=1d/error^2
  fitreg=[[MIN(wavelength),1275],[1275,1300],[1300,1313],[1313,1321],$
    [1321,1330],[1330,1351],[1351,MAX(wavelength)]]
  fitfcn=['ifsf_fitspline','ifsf_fitspline','ifsf_fitspline','ifsf_fitspline',$
    'ifsf_fitspline','ifsf_fitspline','ifsf_fitspline']
  fitargs=HASH()
  fitargs['reg1'] = {argsbkpts:{everyn:40}}
  fitargs['reg2'] = {argsbkpts:{everyn:50}}
  fitargs['reg3'] = {argsbkpts:{everyn:50}}
  fitargs['reg4'] = {argsbkpts:{everyn:90}}
  fitargs['reg5'] = {argsbkpts:{everyn:100}}
  fitargs['reg6'] = {argsbkpts:{everyn:90}}
  fitargs['reg7'] = {argsbkpts:{everyn:195}}
