FUNCTION cos_pg1613OVI, directoryname, gal, zgal, profileshifts, profilesig, coveringfactor,$
  ...
  zgalint=DOUBLE(zgal)
  doubletregion=[1148,1173]
  checkindex=[1148,1159]
  ...
  indextoplot=[INDGEN(VALUE_LOCATE(wavelength,1150),START=spectramin),$
    ...
    INDGEN(VALUE_LOCATE(wavelength,1386.6)  - VALUE_LOCATE(wavelength,1385),  START=VALUE_LOCATE(wavelength,1385)),$
    INDGEN(N_ELEMENTS(wavelength)           - VALUE_LOCATE(wavelength,1386.7),  START=VALUE_LOCATE(wavelength,1386.7))]
  weight=1d/error^2
  ...
  fitargs['reg3'] = {argsbkpts:{everyn:80}}
