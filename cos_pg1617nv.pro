FUNCTION cos_pg1617nv, directoryname, gal, zgal, profileshifts, profilesig, coveringfactor,$
  ...
  zgalint=DOUBLE(zgal)
  doubletregion=[1363,1390]
  checkindex=[1366,1374]
  ...
  indextoplot=[INDGEN(VALUE_LOCATE(wavelength,1133),START=spectramin), $
    INDGEN(VALUE_LOCATE(wavelength,1137.5)-VALUE_LOCATE(wavelength,1135),START=VALUE_LOCATE(wavelength,1135)),$
    INDGEN(VALUE_LOCATE(wavelength,1142)-VALUE_LOCATE(wavelength,1141.45),START=VALUE_LOCATE(wavelength,1141.45)),$
    INDGEN(VALUE_LOCATE(wavelength,1142.9)-VALUE_LOCATE(wavelength,1142.5),START=VALUE_LOCATE(wavelength,1142.5)),$
    INDGEN(VALUE_LOCATE(wavelength,1145.34)-VALUE_LOCATE(wavelength,1145.17),START=VALUE_LOCATE(wavelength,1145.17)),$
    INDGEN(VALUE_LOCATE(wavelength,1149)-VALUE_LOCATE(wavelength,1146),START=VALUE_LOCATE(wavelength,1146)),$
    INDGEN(VALUE_LOCATE(wavelength,1152)-VALUE_LOCATE(wavelength,1151),START=VALUE_LOCATE(wavelength,1151)),$
    INDGEN(VALUE_LOCATE(wavelength,1152.5)-VALUE_LOCATE(wavelength,1152.2),START=VALUE_LOCATE(wavelength,1152.2)),$
    INDGEN(VALUE_LOCATE(wavelength,1360)-VALUE_LOCATE(wavelength,1153),START=VALUE_LOCATE(wavelength,1153)),$
    INDGEN(VALUE_LOCATE(wavelength,1365.2)-VALUE_LOCATE(wavelength,1360),START=VALUE_LOCATE(wavelength,1360)),$
    INDGEN(VALUE_LOCATE(wavelength,1369.8)-VALUE_LOCATE(wavelength,1369),START=VALUE_LOCATE(wavelength,1369)),$
    INDGEN(VALUE_LOCATE(wavelength,1372)-VALUE_LOCATE(wavelength,1371),START=VALUE_LOCATE(wavelength,1371)),$
    INDGEN(N_ELEMENTS(wavelength)-VALUE_LOCATE(wavelength,1373.4),START=VALUE_LOCATE(wavelength,1373.4))]
  weight=1d/error^2
  fitreg=[[MIN(wavelength),1160],[1160,1330],[1330,1390],[1390,MAX(wavelength)]]
  ...
  fitargs['reg4'] = {argsbkpts:{everyn:50}}
  ...
  img = cgsnapshot(filename=directoryname+gal+'/'+'NV'+'_continuum',/jpeg,/nodialog,quality=100)
  
  relativeflux=flux/continuum
  
  ; Removing problem areas by setting error to 0 so that MPFITFUN ignores it
  error[VALUE_LOCATE(wavelength, 1144):VALUE_LOCATE(wavelength,1145.2)] = 1d99
  error[VALUE_LOCATE(wavelength, 1152.3):VALUE_LOCATE(wavelength,1154.3)] = 1d99
  error[VALUE_LOCATE(wavelength, 1365):VALUE_LOCATE(wavelength,1367.8)] = 1d99
