FUNCTION cos_pg0844nv, directoryname, gal, zgal, profileshifts, profilesig, coveringfactor,$
  ...
  zgalint=DOUBLE(zgal)
  doubletregion=[1318,1324]
  checkindex=[1317,1324]
  ...
  indextoplot=[INDGEN(VALUE_LOCATE(wavelength,1318.4),START=spectramin), $
    INDGEN(VALUE_LOCATE(wavelength,1322.5)-VALUE_LOCATE(wavelength,1319.3),START=VALUE_LOCATE(wavelength,1319.3)),$
    INDGEN(N_ELEMENTS(wavelength)-VALUE_LOCATE(wavelength,1323.4),START=VALUE_LOCATE(wavelength,1323.4))]
  weight=1d/error^2
  fitreg=[[MIN(wavelength),1313],[1313,1328],[1328,MAX(wavelength)]]
