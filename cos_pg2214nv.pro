FUNCTION cos_pg2214nv, directoryname, gal, zgal, profileshifts, $
  ...
  linefitreg=[1308,1327]
  lineplotreg=[1308,1327]
  contplotreg=[1308,1327]
  ...
  goodind = [[1308,1309.5],[1311.1,1313.8],[1322.5,1327]]
  ...
  weight=1d/error^2
  contfitreg=[[1308,1312.5],[1312.5,1323.5],[1323.5,1327]]
