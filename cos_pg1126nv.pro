FUNCTION cos_pg1126nv, directoryname, gal, zgal, profileshifts, profilesig, coveringfactor,$
  ...
  lines=CALL_FUNCTION('ifsf_linelist',['[NV1]1239','[NV2]1243'])
  ;  checkindex1=lines['[NV1]1239']-50
  ;  checkindex2=lines['[NV2]1243']+50
  zgalint=DOUBLE(zgal)
  doubletregion=[1290,1323]
  checkindex=[1292,1321]
  ...
  Doubletabsorptionregion=[VALUE_LOCATE(wavelength,1290),VALUE_LOCATE(wavelength,1315)]
  hydrogenabsorptionregion=[VALUE_LOCATE(wavelength,1275),VALUE_LOCATE(wavelength,1290)]
  spectramin=VALUE_LOCATE(wavelength,MIN(wavelength))
  spectramax=VALUE_LOCATE(wavelength,MAX(wavelength))
    indextoplot=[INDGEN(VALUE_LOCATE(wavelength,1275)), $
      INDGEN(VALUE_LOCATE(wavelength,1278.3)-VALUE_LOCATE(wavelength,1278.2),START=VALUE_LOCATE(wavelength,1278.2)),$
      INDGEN(VALUE_LOCATE(wavelength,1280.55)-VALUE_LOCATE(wavelength,1280.2),START=VALUE_LOCATE(wavelength,1280.2)), $
      INDGEN(VALUE_LOCATE(wavelength,1283)-VALUE_LOCATE(wavelength,1282),START=VALUE_LOCATE(wavelength,1282)),$
      INDGEN(VALUE_LOCATE(wavelength,1286.5)-VALUE_LOCATE(wavelength,1285.4),START=VALUE_LOCATE(wavelength,1285.4)),$
      INDGEN(VALUE_LOCATE(wavelength,1288)-VALUE_LOCATE(wavelength,1287.4),START=VALUE_LOCATE(wavelength,1287.4)),$
      INDGEN(VALUE_LOCATE(wavelength,1288.7)-VALUE_LOCATE(wavelength,1288.5),START=VALUE_LOCATE(wavelength,1288.5)),$
      INDGEN(VALUE_LOCATE(wavelength,1292)-VALUE_LOCATE(wavelength,1291.4),START=VALUE_LOCATE(wavelength,1291.4)),$
      INDGEN(VALUE_LOCATE(wavelength,1297.75)-VALUE_LOCATE(wavelength,1296.55),START=VALUE_LOCATE(wavelength,1296.55)),$
      INDGEN(VALUE_LOCATE(wavelength,1301.75)-VALUE_LOCATE(wavelength,1301.55),START=VALUE_LOCATE(wavelength,1301.55)),$
      INDGEN(VALUE_LOCATE(wavelength,1302.8)-VALUE_LOCATE(wavelength,1302.6),START=VALUE_LOCATE(wavelength,1302.6)),$
      INDGEN(VALUE_LOCATE(wavelength,1306.9)-VALUE_LOCATE(wavelength,1306.25),START=VALUE_LOCATE(wavelength,1306.25)),$
      INDGEN(VALUE_LOCATE(wavelength,1310.95)-VALUE_LOCATE(wavelength,1310.6),START=VALUE_LOCATE(wavelength,1310.6)),$
      INDGEN(VALUE_LOCATE(wavelength,1315.2)-VALUE_LOCATE(wavelength,1314),START=VALUE_LOCATE(wavelength,1314)),$
      INDGEN(VALUE_LOCATE(wavelength,1316.8)-VALUE_LOCATE(wavelength,1315.7),START=VALUE_LOCATE(wavelength,1315.7)),$
      INDGEN(spectramax-VALUE_LOCATE(wavelength,1318),START=VALUE_LOCATE(wavelength,1318))]
    weight = 1d/error^2
    fitreg=[[spectramin,1274],[1274,1290],[1290,1315],[1315,spectramax]]
    fitfcn=['ifsf_fitspline','ifsf_fitspline','ifsf_fitspline','ifsf_fitspline']
    fitargs=HASH()
    fitargs['reg1'] = {argsbkpts:{everyn:50}}
    fitargs['reg2'] = {argsbkpts:{everyn:70}}
    fitargs['reg3'] = {argsbkpts:{everyn:140}}
    fitargs['reg4'] = {argsbkpts:{everyn:200}}
  ...
  error[VALUE_LOCATE(wavelength, 1301.5):VALUE_LOCATE(wavelength,1302.7)] = 1d99
  error[VALUE_LOCATE(wavelength, 1306.3):VALUE_LOCATE(wavelength,1307)] = 1d99
  ...
  if keyword_set(initnad) then begin
    ...
    initnad = {$
      ...
      fcnfitnad: 'ifsf_uvabsfcnNV',$
      fcninitpar: 'ifsf_inituvabsNV',$
