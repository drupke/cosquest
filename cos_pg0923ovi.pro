FUNCTION cos_pg0923ovi, directoryname, gal, zgal, profileshifts, profilesig, coveringfactor,$
  ...
  zgalint=DOUBLE(zgal)
  doubletregion=[1221,1238]
  checkindex=[1221,1241]
  ...
  indextoplot=[INDGEN(VALUE_LOCATE(wavelength,1214),START=spectramin), $
    INDGEN(VALUE_LOCATE(wavelength,1220.6)-VALUE_LOCATE(wavelength,1218),START=VALUE_LOCATE(wavelength,1218)),$
    INDGEN(VALUE_LOCATE(wavelength,1230.2)-VALUE_LOCATE(wavelength,1228),START=VALUE_LOCATE(wavelength,1228)),$
    INDGEN(VALUE_LOCATE(wavelength,1236)-VALUE_LOCATE(wavelength,1233.8),START=VALUE_LOCATE(wavelength,1233.8)),$
    INDGEN(VALUE_LOCATE(wavelength,1239.2)-VALUE_LOCATE(wavelength,1237.5),START=VALUE_LOCATE(wavelength,1237.5)),$
    INDGEN(N_ELEMENTS(wavelength)-VALUE_LOCATE(wavelength,1240.6),START=VALUE_LOCATE(wavelength,1240.6))]
  weight=1d/error^2
  fitreg=[[MIN(wavelength),1218],[1218,1242],[1242,MAX(wavelength)]]
