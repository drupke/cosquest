FUNCTION cos_pg2130nv, directoryname, gal, zgal, profileshifts, profilesig, coveringfactor,$
  ...
  indextoplot=[INDGEN(VALUE_LOCATE(wavelength,1301.5),START=spectramin),$
    INDGEN(VALUE_LOCATE(wavelength,1309.3)    - VALUE_LOCATE(wavelength,1304.6),    START=VALUE_LOCATE(wavelength,1304.6)),$
    INDGEN(VALUE_LOCATE(wavelength,1313.7)    - VALUE_LOCATE(wavelength,1310.6),    START=VALUE_LOCATE(wavelength,1310.6)),$
    INDGEN(VALUE_LOCATE(wavelength,1316.4)    - VALUE_LOCATE(wavelength,1314.8),    START=VALUE_LOCATE(wavelength,1314.8)),$
    INDGEN(VALUE_LOCATE(wavelength,1320.6)    - VALUE_LOCATE(wavelength,1317.5),    START=VALUE_LOCATE(wavelength,1317.5)),$
    INDGEN(N_ELEMENTS(wavelength)           - VALUE_LOCATE(wavelength,1320.2),  START=VALUE_LOCATE(wavelength,1320.2))]
  weight=1d/error^2
  fitreg=[[MIN(wavelength),1295],[1295,1322],[1322,MAX(wavelength)]]
