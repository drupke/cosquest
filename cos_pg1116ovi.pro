FUNCTION cos_pg1116ovi, directoryname, gal, zgal, profileshifts, profilesig, coveringfactor,$
  ...
  zgalint=DOUBLE(zgal)
  doubletregion=[1185,1218]
  checkindex=[1195,1210]
  ...
  hydrogenabsorptionregion=[VALUE_LOCATE(wavelength,1195),VALUE_LOCATE(wavelength,1210)]
  spectramin=VALUE_LOCATE(wavelength,MIN(wavelength))
  spectramax=VALUE_LOCATE(wavelength,MAX(wavelength))
  indextoplot=[INDGEN(VALUE_LOCATE(wavelength,1189.8),START=spectramin), $
    INDGEN(VALUE_LOCATE(wavelength,1192.4)-VALUE_LOCATE(wavelength,1191.6),START=VALUE_LOCATE(wavelength,1191.6)),$
    INDGEN(VALUE_LOCATE(wavelength,1195.5)-VALUE_LOCATE(wavelength,1194.5),START=VALUE_LOCATE(wavelength,1194.5)),$
    INDGEN(VALUE_LOCATE(wavelength,1198.7)-VALUE_LOCATE(wavelength,1197.5),START=VALUE_LOCATE(wavelength,1197.5)),$
    INDGEN(VALUE_LOCATE(wavelength,1202)-VALUE_LOCATE(wavelength,1201.5),START=VALUE_LOCATE(wavelength,1201.5)),$
    INDGEN(VALUE_LOCATE(wavelength,1203.2)-VALUE_LOCATE(wavelength,1203),START=VALUE_LOCATE(wavelength,1203)),$
    INDGEN(VALUE_LOCATE(wavelength,1205.7)-VALUE_LOCATE(wavelength,1204.3),START=VALUE_LOCATE(wavelength,1204.3)),$
    INDGEN(VALUE_LOCATE(wavelength,1208.8)-VALUE_LOCATE(wavelength,1207.8),START=VALUE_LOCATE(wavelength,1207.8)),$
    INDGEN(VALUE_LOCATE(wavelength,1210.5)-VALUE_LOCATE(wavelength,1210.2),START=VALUE_LOCATE(wavelength,1210.2)),$
    INDGEN(VALUE_LOCATE(wavelength,1214.5)-VALUE_LOCATE(wavelength,1211.2),START=VALUE_LOCATE(wavelength,1211.2)),$
    INDGEN(VALUE_LOCATE(wavelength,1221)-VALUE_LOCATE(wavelength,1216.9),START=VALUE_LOCATE(wavelength,1216.9)),$
    INDGEN(N_ELEMENTS(wavelength)-VALUE_LOCATE(wavelength,1222.4),START=VALUE_LOCATE(wavelength,1222.4))]
  weight=1d/error^2
  fitreg=[[MIN(wavelength),1187],[1187,1215.5],[1215.5,1223],[1223,MAX(wavelength)]]
  fitfcn=['ifsf_fitspline','ifsf_fitspline','ifsf_fitspline','ifsf_fitspline']
  fitargs=HASH()
  fitargs['reg1'] = {argsbkpts:{everyn:40}}
  fitargs['reg2'] = {argsbkpts:{everyn:80}}
  fitargs['reg3'] = {argsbkpts:{everyn:100}}
  fitargs['reg4'] = {argsbkpts:{everyn:50}}
  
  cgplot, wavelength, flux, XRAN=checkindex, YRAN=[-.3*MAX(flux[plotrange[0]:VALUE_LOCATE(wavelength,1210)]),1.5*MAX(flux[plotrange[0]:VALUE_LOCATE(wavelength,1210)])],$
...
; Removing problem areas by setting error to 0 so that MPFITFUN ignores it
  error[VALUE_LOCATE(wavelength, 1200):VALUE_LOCATE(wavelength,1209)] = 1d99
  ...
  lines = ['[OVI1]1032','[OVI2]1038',$
    '[LyB]1026','[LyA]1216','[NV1]1239','[NV2]1243','[SiII]1190','[SiII]1193','[NI]1195.5','[NI]1200.2','[NI]1200.71']
