FUNCTION cos_pg1307ovi, directoryname, gal, zgal, profileshifts, profilesig, coveringfactor,$
  ...
  zgalint=DOUBLE(zgal)
  doubletregion=[1176,1198]
  checkindex=[1177,1186]
  ...
  hydrogenabsorptionregion=[VALUE_LOCATE(wavelength,1160),VALUE_LOCATE(wavelength,1170)]
  spectramin=VALUE_LOCATE(wavelength,MIN(wavelength))
  spectramax=VALUE_LOCATE(wavelength,MAX(wavelength))
  indextoplot=[INDGEN(VALUE_LOCATE(wavelength,1178),START=spectramin), $
    INDGEN(VALUE_LOCATE(wavelength,1184.3)-VALUE_LOCATE(wavelength,1179),START=VALUE_LOCATE(wavelength,1179)),$
    INDGEN(VALUE_LOCATE(wavelength,1189.5)-VALUE_LOCATE(wavelength,1185.7),START=VALUE_LOCATE(wavelength,1185.7)),$
    INDGEN(VALUE_LOCATE(wavelength,1192.6)-VALUE_LOCATE(wavelength,1191),START=VALUE_LOCATE(wavelength,1191)),$
    INDGEN(N_ELEMENTS(wavelength)-VALUE_LOCATE(wavelength,1193.7),START=VALUE_LOCATE(wavelength,1193.7))]
  weight=1d/error^2
  fitreg=[[MIN(wavelength),1198],[1198,MAX(wavelength)]]
