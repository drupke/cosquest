FUNCTION cos_pg1411nv, directoryname, gal, zgal, profileshifts, profilesig, coveringfactor,$
  ...
  zgalint=DOUBLE(zgal)
  doubletregion=[1349,1356]
  checkindex=[1347,1357]
  ...
  indextoplot=[INDGEN(VALUE_LOCATE(wavelength,1349.4),START=spectramin),$
        INDGEN(VALUE_LOCATE(wavelength,1349.84)-VALUE_LOCATE(wavelength,1349.7),START=VALUE_LOCATE(wavelength,1349.7)),$
        INDGEN(VALUE_LOCATE(wavelength,1352.8)-VALUE_LOCATE(wavelength,1350.3),START=VALUE_LOCATE(wavelength,1350.2)),$
        INDGEN(VALUE_LOCATE(wavelength,1353.6)-VALUE_LOCATE(wavelength,1353.3),START=VALUE_LOCATE(wavelength,1353.3)),$
        INDGEN(VALUE_LOCATE(wavelength,1354.2)-VALUE_LOCATE(wavelength,1354),START=VALUE_LOCATE(wavelength,1354)),$
        INDGEN(N_ELEMENTS(wavelength)-VALUE_LOCATE(wavelength,1354.5),START=VALUE_LOCATE(wavelength,1354.5))]
  weight=1d/error^2
  fitreg=[[MIN(wavelength),1345],[1345,1360],[1360,MAX(wavelength)]]
  fitfcn=['ifsf_fitspline','ifsf_fitspline','ifsf_fitspline']
  fitargs=HASH()
  fitargs['reg1'] = {argsbkpts:{everyn:40}}
  fitargs['reg2'] = {argsbkpts:{everyn:30}}
  ...
  error[VALUE_LOCATE(wavelength, 1280.3):VALUE_LOCATE(wavelength,1281.2)] = 0
  ...
  if keyword_set(initnad) then begin
    ...
    nadem_siginit = dblarr(ncols,nrows,nad_maxncomp)+20d
