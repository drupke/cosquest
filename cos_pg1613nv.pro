FUNCTION cos_pg1613nv, directoryname, gal, zgal, profileshifts, profilesig, coveringfactor,$
  ...
  zgalint=DOUBLE(zgal)
  doubletregion=[1379,1405]
  checkindex=[1380,1387]
  ...
  indextoplot=[INDGEN(VALUE_LOCATE(wavelength,1150),START=spectramin),$
    INDGEN(VALUE_LOCATE(wavelength,1156.5)    - VALUE_LOCATE(wavelength,1153.6),    START=VALUE_LOCATE(wavelength,1153.6)),$
    INDGEN(VALUE_LOCATE(wavelength,1151.1)    - VALUE_LOCATE(wavelength,1151),    START=VALUE_LOCATE(wavelength,1151)),$
    INDGEN(VALUE_LOCATE(wavelength,1152.4)    - VALUE_LOCATE(wavelength,1151.9),    START=VALUE_LOCATE(wavelength,1151.9)),$
    INDGEN(VALUE_LOCATE(wavelength,1157.8)    - VALUE_LOCATE(wavelength,1157.4),    START=VALUE_LOCATE(wavelength,1157.4)),$
    INDGEN(VALUE_LOCATE(wavelength,1328.5)  - VALUE_LOCATE(wavelength,1158.3),    START=VALUE_LOCATE(wavelength,1158.3)),$
    INDGEN(VALUE_LOCATE(wavelength,1380.6)  - VALUE_LOCATE(wavelength,1378),    START=VALUE_LOCATE(wavelength,1378)),$
    INDGEN(VALUE_LOCATE(wavelength,1382)    - VALUE_LOCATE(wavelength,1381.6),  START=VALUE_LOCATE(wavelength,1381.6)),$
    INDGEN(VALUE_LOCATE(wavelength,1385)  - VALUE_LOCATE(wavelength,1382.6),  START=VALUE_LOCATE(wavelength,1382.6)),$
    INDGEN(VALUE_LOCATE(wavelength,1386.45)  - VALUE_LOCATE(wavelength,1386),  START=VALUE_LOCATE(wavelength,1386)),$
    INDGEN(N_ELEMENTS(wavelength)           - VALUE_LOCATE(wavelength,1387),  START=VALUE_LOCATE(wavelength,1387))]
  weight=1d/error^2
  fitreg=[[MIN(wavelength),1173],[1173,1355],[1355,MAX(wavelength)]]
  fitfcn=['ifsf_fitspline','ifsf_fitspline','ifsf_fitspline']
  fitargs=HASH()
  fitargs['reg1'] = {argsbkpts:{everyn:40}}
  fitargs['reg2'] = {argsbkpts:{everyn:40}}
  fitargs['reg3'] = {argsbkpts:{everyn:40}}
  ...
  img = cgsnapshot(filename=directoryname+'/'+gal+'/'+gal+'NV'+'_continuum',/jpeg,/nodialog,quality=100)
