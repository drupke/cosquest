FUNCTION cos_pg2214nvbackup, directoryname, gal, zgal, profileshifts, profilesig, coveringfactor,$
  ...
  readcol,directoryname+gal+'.txt', wavelength, flux, error, FORMAT='D,D,D'
  ...
  zgalint=DOUBLE(zgal)
  doubletregion=[1309,1324]
  plotrange=[VALUE_LOCATE(wavelength, doubletregion[0]-5),VALUE_LOCATE(wavelength,doubletregion[1]+5)]
  ...
  indextoplot=[INDGEN(VALUE_LOCATE(wavelength,1301.5),START=spectramin),$
    INDGEN(VALUE_LOCATE(wavelength,1309.5)    - VALUE_LOCATE(wavelength,1307),    START=VALUE_LOCATE(wavelength,1307)),$
    INDGEN(VALUE_LOCATE(wavelength,1313.8)    - VALUE_LOCATE(wavelength,1311.1),    START=VALUE_LOCATE(wavelength,1311.1)),$
    INDGEN(VALUE_LOCATE(wavelength,1318.6)    - VALUE_LOCATE(wavelength,1315),    START=VALUE_LOCATE(wavelength,1315)),$
    INDGEN(VALUE_LOCATE(wavelength,1320.2)    - VALUE_LOCATE(wavelength,1319.2),    START=VALUE_LOCATE(wavelength,1319.2)),$
    INDGEN(N_ELEMENTS(wavelength)           - VALUE_LOCATE(wavelength,1323),  START=VALUE_LOCATE(wavelength,1323))]
  weight=1d/error^2
  fitreg=[[MIN(wavelength),1303],[1303,1327],[1327,MAX(wavelength)]]
  ...
  cgplot, wavelength, flux, XRAN=checkindex, YRAN=[-.3*MAX(flux[plotrange[0]:plotrange[1]]),1.5*MAX(flux[plotrange[0]:plotrange[1]])],$
    ...
    xtit='Wavelength ($\Angstrom$)',ytit='Flux'
  ...
  img = cgsnapshot(filename=directoryname+'/'+gal+'_continuum',/jpeg,/nodialog,quality=100)
