FUNCTION cos_pg1440nv, directoryname, gal, zgal, profileshifts, profilesig, coveringfactor,$
  ...
  zgalint=DOUBLE(zgal)
  doubletregion=[1323,1342]
  checkindex=[1323,1342]
  ...
  checkindex=doubletregion
  spectramin=VALUE_LOCATE(wavelength,MIN(wavelength))
  spectramax=VALUE_LOCATE(wavelength,MAX(wavelength))
  indextoplot=[INDGEN(VALUE_LOCATE(wavelength,1324.3),START=spectramin),$
    INDGEN(VALUE_LOCATE(wavelength,1326.5)-VALUE_LOCATE(wavelength,1325),START=VALUE_LOCATE(wavelength,1325)),$
    INDGEN(VALUE_LOCATE(wavelength,1328.5)-VALUE_LOCATE(wavelength,1327.8),START=VALUE_LOCATE(wavelength,1327.8)),$
    INDGEN(VALUE_LOCATE(wavelength,1331)-VALUE_LOCATE(wavelength,1329),START=VALUE_LOCATE(wavelength,1329)),$
    INDGEN(VALUE_LOCATE(wavelength,1333.8)-VALUE_LOCATE(wavelength,1332.2),START=VALUE_LOCATE(wavelength,1332.2)),$
    INDGEN(VALUE_LOCATE(wavelength,1335.4)-VALUE_LOCATE(wavelength,1334.7),START=VALUE_LOCATE(wavelength,1334.7)),$
    INDGEN(VALUE_LOCATE(wavelength,1336.1)-VALUE_LOCATE(wavelength,1335.9),START=VALUE_LOCATE(wavelength,1335.9)),$
    INDGEN(VALUE_LOCATE(wavelength,1340.3)-VALUE_LOCATE(wavelength,1336.5),START=VALUE_LOCATE(wavelength,1336.5)),$
    INDGEN(N_ELEMENTS(wavelength)-VALUE_LOCATE(wavelength,1340.9),START=VALUE_LOCATE(wavelength,1340.9))]
  weight=1d/error^2
  fitreg=[[MIN(wavelength),1320],[1320,1340],[1340,MAX(wavelength)]]
  ...
  if keyword_set(initnad) then begin
    ...
    FOR I = 0, comps-1 DO BEGIN
      nadabs_zinit[*,*,I] += profileshifts[I]/1238.8210d
    ENDFOR
